...
\includegraphics[scale=0.6]{R7.pdf}
\end{tikzfigure}
      ...
      \note[targetoffsetx=-13cm, targetoffsety=-13cm, width=28cm, innersep=0cm]
{
   ...
   \vspace{-90pt}
	...
	\includegraphics[scale=0.30]{Logos.pdf}
...
%  \begin{center}
    \begin{itemize}
        \item Test our hypothesis of hybrid vigor (within subspecies heterosis vs between subspecies)
